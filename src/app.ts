...
const s = Framer.Importer.load("imported/Screens- for David@1x");
...
s.Button_23.onTouchEnd(() => {
	...
	Utils.delay(1.5, () => {
		...
		const scrollFrame = new ScrollComponent({
			y: 39,
			height: 1334 - 98 - 39,
			width: 750
		});
...
s.Color_Selector.onTouchEnd(() => {
	...
	Utils.delay(3, () => {
		...
		s.Tab_Bar.y = 1334 - 98;
		s.Tab_Bar.x = 0;
		const scrollFrame2 = new ScrollComponent({
			y: 0,
			height: 1334 - 98,
			width: 750
		});
...
s.Search_inactive.onTouchEnd(() => {
	...
	const scrollFrame3 = new ScrollComponent({
		y: 0,
		height: 1334 - 98,
		width: 750
	});
